...
<AccordionGroup>
  ...
  <Accordion title="Preview changes" description="333" defaultOpen icon="web-awesome">
...
<Update label="04/25/2025" description>
...
<Steps>
  <Step title="wee" icon="web-awesome">
